    ...
    try:
        ...
        try:
            with conection.cursor() as cursor:
                ...
                query = 'SELECT fecha, dosis_administradas, personas_vacunadas, completamente_vacunadas, porcentaje_completamente_vacunadas FROM vacunas_covid19 WHERE pais_id = ' + str(country_id) + ';'
